...
class KoreanCultureInfoScreen extends StatefulWidget {
  @override
  _KoreanCultureInfoScreenState createState() => _KoreanCultureInfoScreenState();
}

class _KoreanCultureInfoScreenState extends State<KoreanCultureInfoScreen> {
