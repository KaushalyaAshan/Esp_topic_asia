...
class KoreanStandardBookScreen extends StatefulWidget {
  @override
  _KoreanStandardBookScreenState createState() => _KoreanStandardBookScreenState();
}

class _KoreanStandardBookScreenState extends State<KoreanStandardBookScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 6,
        // Slightly higher elevation for a bolder shadow
